...
var PointingAccuracy; // may change while running!
...
function onDevicePointingAccuracyChanged(Handler) {
    registerHandler(Handler, false);
}
/**** onceDevicePointingAccuracyChanged ****/
function onceDevicePointingAccuracyChanged(Handler) {
    registerHandler(Handler, true);
}
/**** offDevicePointingAccuracyChanged ****/
function offDevicePointingAccuracyChanged(Handler) {
    unregisterHandler(Handler);
}
/**** observePointingAccuracy (e.g., on "convertibles") ****/
var AccuracyPoller = undefined;
function observePointingAccuracy() {
    AccuracyPoller = setInterval(function () {
        var oldPointingAccuracy = PointingAccuracy;
        updatePointingAccuracy();
...
exports.default = {
    ...
    onDevicePointingAccuracyChanged: onDevicePointingAccuracyChanged,
    onceDevicePointingAccuracyChanged: onceDevicePointingAccuracyChanged,
    offDevicePointingAccuracyChanged: offDevicePointingAccuracyChanged,
